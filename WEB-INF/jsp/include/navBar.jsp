                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td align="right" style="font-weight: normal;">
                                        ...
                                        <form METHOD="GET" action="${urlPrefix}ListStudySubjects" onSubmit=" if (document.forms[0]['findSubjects_f_studySubject.label'].value == '<fmt:message key="" bundle="${resword}"/>') { document.forms[0]['findSubjects_f_studySubject.label'].value=''}">
